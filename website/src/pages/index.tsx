    ...
    <header className="hero-bg flex-1 flex px-12 sm:px-24 py-12 sm:py-20 shadow-md">
      <div className="max-w-5xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-1 sm:gap-4 mt-4">
          <a className="my-btn text-white text-lg bg-blue-600 border-blue-600 hover:bg-blue-700 w-full mb-2 sm:w-auto" href="/docs/intro" style={{outline: "none"}}>Get started</a>
          <a className="my-btn border-2 text-blue-600 text-lg border-blue-600 hover:bg-blue-100 w-full mb-2 sm:w-auto tw-border-solid" href="https://github.com/matanolabs/matano" style={{outline: "none"}}>
